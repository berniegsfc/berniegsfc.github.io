...
; </ol>
;
; @copyright Copyright (c) 2010-2024 United States Government as 
...
; @param value {in} {type=string}
;     julday value.
; @keyword basicFormat {in} {optional} {type=boolean} {default=false}
;     Indicates whether the "basic" (minimal field separators) ISO 8601
...
; @field basicIso8601Format constant format string for a "basic" (minimal
;     field separators) ISO 8601 value.
;-
